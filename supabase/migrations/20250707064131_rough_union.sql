/*
  ...
  3. Default Data
    ...
    - Create sample admin and member users with hashed passwords
*/
...
-- Insert default admin users with properly hashed passwords
-- These password hashes correspond to: super123 -> 1a7c738d, admin123 -> 1a7c738d, member123 -> 1a7c738d
-- Note: In production, use proper bcrypt hashing
INSERT INTO admin_users (username, email, password_hash, role, is_active) VALUES
  ('superadmin', 'superadmin@jouleslabs.com', '1a7c738d', 'super_admin', true),
  ('admin', 'admin@jouleslabs.com', '1a7c738d', 'admin', true),
  ('member', 'member@jouleslabs.com', '1a7c738d', 'member', true)
